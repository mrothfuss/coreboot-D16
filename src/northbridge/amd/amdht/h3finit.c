...
static const uint32_t ht_speed_limit[20] =
	{0xFFFFF, 0xE7FF5, 0x67FF5, 0x27FF5,
	 0x07FF5, 0x03FF5, 0x01FF5, 0x00FF5,
	 0x007F5, 0x003F5, 0x001F5, 0x000F5,
	 0x00075, 0x00035, 0x00015, 0x00005,
	 0x00005, 0x00001, 0x00001, 0x00001};
